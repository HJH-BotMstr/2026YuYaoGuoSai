...
在 [grasp_node.py](lite3_ws/src/grasp_task/grasp_task/grasp_node.py) 顶部：
...
| 文件/目录 | 变更类型 | 说明 |
|---|---|---|
| `lite3_ws/src/grasp_task/` | 新增 | 完整 ROS2 包 |
| `lite3_ws/src/grasp_task/grasp_task/grasp_node.py` | 新增 | ROS2 抓取任务节点 |
| `lite3_ws/src/grasp_task/grasp_task/config_loader.py` | 新增 | 加载 tools/grasp/config.yaml |
| `lite3_ws/src/grasp_task/grasp_task/motion_waiter.py` | 新增 | 基于 /cmd_vel 的到位判断 |
| `lite3_ws/src/grasp_task/config/grasp_task.yaml` | 新增 | ROS2 参数 |
| `lite3_ws/src/grasp_task/launch/grasp.launch.py` | 新增 | 启动文件 |
| `lite3_ws/src/grasp_task/package.xml` | 新增 | 包元数据 |
| `lite3_ws/src/grasp_task/setup.py` | 新增 | ament_python 入口 |
